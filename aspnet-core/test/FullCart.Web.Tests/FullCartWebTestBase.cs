...
using FullCart.Models.TokenAuth;
...
{
    public abstract class FullCartWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static FullCartWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(FullCartWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<FullCartDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<FullCartDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<FullCartDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<FullCartDbContext, Task<T>> func)
        {
            T result;
